...
export type AllEvents = 'GROUP' | 'GUILDS' | 'GUILD_MEMBERS' | 'GUILD_MESSAGES' | 'GUILD_MESSAGE_REACTIONS' | 'DIRECT_MESSAGE' | 'INTERACTION' | 'MESSAGE_AUDIT' | 'FORUMS_EVENT' | 'AUDIO_ACTION' | 'PUBLIC_GUILD_MESSAGES' | 'C2C_MESSAGE_CREATE' | 'GROUP_AT_MESSAGE_CREATE' | 'DIRECT_MESSAGE_CREATE' | 'AT_MESSAGE_CREATE' | 'MESSAGE_CREATE' | 'GUILD_CREATE' | 'GUILD_UPDATE' | 'GUILD_DELETE' | 'CHANNEL_CREATE' | 'CHANNEL_UPDATE' | 'CHANNEL_DELETE' | 'GUILD_MEMBER_ADD' | 'GUILD_MEMBER_UPDATE' | 'GUILD_MEMBER_REMOVE' | 'AUDIO_OR_LIVE_CHANNEL_MEMBER_ENTER' | 'AUDIO_OR_LIVE_CHANNEL_MEMBER_LEAVE' | 'AUDIO_OR_LIVE_CHANNEL_MEMBER_EXIT' | 'FORUM_THREAD_CREATE' | 'FORUM_THREAD_UPDATE' | 'FORUM_THREAD_DELETE' | 'FORUM_POST_CREATE' | 'FORUM_POST_DELETE' | 'FORUM_REPLY_CREATE' | 'FORUM_REPLY_DELETE' | 'FORUM_PUBLISH_AUDIT_RESULT' | 'OPEN_FORUM_THREAD_CREATE' | 'OPEN_FORUM_THREAD_UPDATE' | 'OPEN_FORUM_THREAD_DELETE' | 'OPEN_FORUM_POST_CREATE' | 'OPEN_FORUM_POST_DELETE' | 'OPEN_FORUM_REPLY_CREATE' | 'OPEN_FORUM_REPLY_DELETE' | 'GROUP_ADD_ROBOT' | 'GROUP_DEL_ROBOT' | 'GROUP_MSG_REJECT' | 'GROUP_MSG_RECEIVE' | 'FRIEND_ADD' | 'FRIEND_DEL' | 'C2C_MSG_REJECT' | 'C2C_MSG_RECEIVE'
